...
| 4B | 發明第二鏈編號（大寫 R、大寫 W、連字號、一位數字）第二條 ID 鏈，R/S 引用該 id | 機械對帳最乾淨 | Stage 1 Non-Goal 與 ID 規則已禁；靠近第二套方法論 | 高 | `1-discussion.md:117`；`_templates/1-discussion.md:50-51` 不另發 Journey/Actor ID |
