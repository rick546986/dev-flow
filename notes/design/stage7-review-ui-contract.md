...
> 本刀不產 HTML、不發明產檔器、不改 twin 執行板。

## 何時用

寫或改第 7 站給人看的審查頁(截圖槽)時。chrome 跟第 2／4／5 站同一套,
不要另發明殼、不要另發明 class 名。

## 版面鎖死(已拍板)

下列六條是鎖死,不是口味、不是選配。產檔器這輪不做。
寫法落點:`_templates/7-review.md`(本檔是正本,不另開家族、不進 README)。
...
6. **chrome 同一套**:跟第 2／4／5 站一樣,必須點名 `--ground`、`--panel`、
   `--accent`,加 `.r-block`。外層撐滿卡寬。mermaid 禁。寬 ASCII 禁。
