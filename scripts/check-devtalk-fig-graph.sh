...
TOOTH_CASES = (
    ...
    ("bad-tooth2-bare-confirmed", "CONFIRMED"),
    ("bad-tooth3-path-not-in-context", "Context"),
    ("bad-tooth3-range-exceeds", "行段須 ⊆"),
    ("bad-tooth3-bare-path", "Context"),
    ("bad-tooth3a-no-cite", "path:L"),
    ("bad-tooth3b-comment-only", "Context"),
    ("bad-tooth-toplevel-prose", "未知內容"),
...
def check_log_teeth():
    """牙 1–4:good 綠;每條牙一份 bad 必須紅。mutation 複本可沒有 bad 目錄。"""
