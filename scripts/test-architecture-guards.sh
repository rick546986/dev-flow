...
check_static_pin "scripts/check-file-map.sh" "EXPECTED_MAPPED_FILES = 157" "EXPECTED_MAPPED_FILES 釘死 157(精確值,不是地板;2026-08-27 scan-html 刀加 build-scan-html.py 後的實得數)"
