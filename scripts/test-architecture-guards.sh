...
check_static_pin "scripts/check-file-map.sh" "EXPECTED_MAPPED_FILES = 159" "EXPECTED_MAPPED_FILES 釘死 159(精確值,不是地板;2026-08-28 vbox-fig 刀加 build-vbox-fig.py + check-vbox-fig.sh 後的實得數)"
