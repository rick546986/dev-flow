...
check_static_pin "scripts/check-file-map.sh" "EXPECTED_MAPPED_FILES = 179" "EXPECTED_MAPPED_FILES 釘死 179(精確值,不是地板;2026-08-28 三邊 plugin 薄殼牙加 check-plugin-hosts.sh + test-plugin-hosts.sh,疊在第 3／4 站審頁產器 177 之上)"
