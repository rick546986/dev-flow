...
check_static_pin "scripts/check-file-map.sh" "EXPECTED_MAPPED_FILES = 143" "EXPECTED_MAPPED_FILES 釘死 143(精確值,不是地板;2026-08-23 Stage 3 第一刀加 check-devstage3-graph.sh + test-devstage3-graph.sh 後的實得數)"
