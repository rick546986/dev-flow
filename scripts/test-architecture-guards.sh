...
check_static_pin "scripts/check-py-floor.sh" "MIN_HEREDOCS = 223" "MIN_HEREDOCS 釘死 223(精確實測;含 bootstrap + check-preload-ban.sh + test-diagir.sh + requirement-discovery-gaps DG mutate +2;不留餘裕否則 PF-2 假綠)"
