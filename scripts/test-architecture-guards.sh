...
check_static_pin "scripts/check-file-map.sh" "EXPECTED_MAPPED_FILES = 177" "EXPECTED_MAPPED_FILES 釘死 177(精確值,不是地板;2026-08-28 第 3／4 站審頁產器加 build-stage3-html.py + build-stage4-html.py + 兩支契約牙,疊在 #62 Pages 173 之上)"
