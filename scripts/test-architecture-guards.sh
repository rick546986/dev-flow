...
check_static_pin "scripts/check-file-map.sh" "EXPECTED_MAPPED_FILES = 154" "EXPECTED_MAPPED_FILES 釘死 154(精確值,不是地板;2026-08-25 talk-html-scan 第二刀加 check-devtalk-fig-graph.sh 後的實得數)"
