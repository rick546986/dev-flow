...
check_static_pin "scripts/check-file-map.sh" "EXPECTED_MAPPED_FILES = 156" "EXPECTED_MAPPED_FILES 釘死 156(精確值,不是地板;2026-08-25 stage-fig-text 第三刀加 check-devstage-fig-text.sh 後的實得數)"
