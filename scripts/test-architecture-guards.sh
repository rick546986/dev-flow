...
check_static_pin "scripts/check-py-floor.sh" "MIN_HEREDOCS = 216" "MIN_HEREDOCS 釘死 216(#113 heredoc 掃描補上後的實得數;2026-09-10 host-stack-fit 收據／I2 牙 +2 → 216,精確值不留餘裕)"
check_static_pin "scripts/check-file-map.sh" "EXPECTED_MAPPED_FILES = 193" "EXPECTED_MAPPED_FILES 釘死 193(精確值;host-stack-fit 收據／I2 牙 +3)"
