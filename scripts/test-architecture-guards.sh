...
check_static_pin "scripts/check-file-map.sh" "EXPECTED_MAPPED_FILES = 145" "EXPECTED_MAPPED_FILES 釘死 145(精確值,不是地板;2026-08-24 Stage 4 第一刀加 check-devstage4-graph.sh + test-devstage4-graph.sh 後的實得數)"
