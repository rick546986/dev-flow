...
check_static_pin "scripts/check-file-map.sh" "EXPECTED_MAPPED_FILES = 173" "EXPECTED_MAPPED_FILES 釘死 173(精確值,不是地板;2026-08-28 站審 html 掛 Pages 加 publish-pages.sh + check-pages-hosting.sh,疊在 #61 產器 171 之上)"
