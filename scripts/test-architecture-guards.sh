...
check_static_pin "scripts/check-file-map.sh" "EXPECTED_MAPPED_FILES = 151" "EXPECTED_MAPPED_FILES 釘死 151(精確值,不是地板;2026-08-24 Stage 7 第一刀加 check-devstage7-graph.sh + test-devstage7-graph.sh 後的實得數)"
