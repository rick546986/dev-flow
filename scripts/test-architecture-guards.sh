...
check_static_pin "scripts/check-dev-setup-discipline.sh" "MIN_CHECKS = 28" "MIN_CHECKS 釘死 28(A-2/B-5 輪 → 18;2026-08-28 ⑪殘件 +5 → 23;⑫Python 地板 +2 → 25;HISTORY 種子不准自動清 +1 → 26;ship-manifest ⑩ +1 → 27;2026-09-04 #96 ⑬trash 目錄進 .gitignore +1 → 28)"
