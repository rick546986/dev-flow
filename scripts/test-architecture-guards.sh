...
check_static_pin "scripts/check-file-map.sh" "EXPECTED_MAPPED_FILES = 139" "EXPECTED_MAPPED_FILES 釘死 139(精確值,不是地板;2026-08-23 公開文件人頁加 build-public-docs.py + check-public-docs.sh 後的實得數)"
