...
check_static_pin "scripts/check-gate-twin.sh" "MIN_CHECKS = 176" "MIN_CHECKS 釘死 176(7-review 審查卡形狀:判定／出貨／爭點／風險／抽驗列 2–3 問 +9 後的實得數)"
...
check_static_pin "scripts/check-file-map.sh" "EXPECTED_MAPPED_FILES = 155" "EXPECTED_MAPPED_FILES 釘死 155(精確值,不是地板;2026-08-25 talk-fig-journey 第二刀加 check-devtalk-fig-journey.sh 後的實得數)"
