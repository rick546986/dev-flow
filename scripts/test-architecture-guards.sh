...
check_static_pin "scripts/check-file-map.sh" "EXPECTED_MAPPED_FILES = 147" "EXPECTED_MAPPED_FILES 釘死 147(精確值,不是地板;2026-08-24 Stage 5 第一刀加 check-devstage5-graph.sh + test-devstage5-graph.sh 後的實得數)"
