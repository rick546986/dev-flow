...
check_static_pin "scripts/check-file-map.sh" "EXPECTED_MAPPED_FILES = 137" "EXPECTED_MAPPED_FILES 釘死 137(精確值,不是地板;2026-08-22 Stage 1 第一刀加 check-devtalk-graph.sh + test-devtalk-graph.sh 後的實得數)"
