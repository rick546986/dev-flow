...
check_static_pin "scripts/check-file-map.sh" "EXPECTED_MAPPED_FILES = 149" "EXPECTED_MAPPED_FILES 釘死 149(精確值,不是地板;2026-08-24 Stage 6 第一刀加 check-devstage6-graph.sh + test-devstage6-graph.sh 後的實得數)"
