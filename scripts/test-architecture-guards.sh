...
p = pathlib.Path(sys.argv[1]) / "README.md"
t = p.read_text(encoding="utf-8")
n = t.replace("devflow-evidence-gauntlet.sh`(1.3.1,", "devflow-evidence-gauntlet.sh`(9.9.9,", 1)
...
t = p.read_text(encoding="utf-8")
n = t.replace('"gauntlet": "1.3.1"', '"gauntlet": "9.9.9"', 1)
...
t = p.read_text(encoding="utf-8")
n = t.replace("**現行 Gauntlet 版本:1.3.1**", "**現行 Gauntlet 版本:9.9.9**", 1)
...
p = pathlib.Path(sys.argv[1]) / "notes/design/evidence-gauntlet.md"
t = p.read_text(encoding="utf-8")
n = t.replace("**現行 Gauntlet 版本:1.3.1**\n", "", 1)
...
t = p.read_text(encoding="utf-8")
n = t.replace('GAUNTLET_VERSION="1.3.1"', 'GAUNTLET_VERSION="9.9.9"', 1)
