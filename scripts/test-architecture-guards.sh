...
check_static_pin "scripts/check-dev-setup-discipline.sh" "MIN_CHECKS = 25" "MIN_CHECKS 釘死 25(A-2/B-5 輪 → 18;2026-08-28 ⑪upgrade 殘件刪除 +5 → 23;⑫產圖 Python 3.12+ venv／不要覆寫 +2 → 25)"
