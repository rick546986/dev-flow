...
check_static_pin "scripts/check-file-map.sh" "EXPECTED_MAPPED_FILES = 171" "EXPECTED_MAPPED_FILES 釘死 171(精確值,不是地板;2026-08-28 第 1／2／5／7 站審頁產器 + 牙 +7,疊在 Human verdict 164 之上)"
