...
check_static_pin "scripts/check-file-map.sh" "EXPECTED_MAPPED_FILES = 141" "EXPECTED_MAPPED_FILES 釘死 141(精確值,不是地板;2026-08-23 Stage 2 第一刀加 check-devstage2-graph.sh + test-devstage2-graph.sh 後的實得數)"
