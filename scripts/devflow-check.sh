...
group_methodology() {
  ...
  # 圖表 IR 閘牙:validate／deliver／wire／route／lab／static-scope。
  # 加在現有三支牙旁邊,不取代 check-vbox-fig／check-gate-twin／check-dir-tree,
  # 也不另造 check-diagir-lab.sh。
  ...
  # Stage 3:觸發判定 + 跳過 hop;單產物 3-prototype.md;N1 不得寫檔,N-skip 落檔最小觸發判定。
