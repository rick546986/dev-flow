...
五站開發流程（Intake→Decide→Spec→Build→Ship），只有 Ship 是預設人類停點。給 agent 跑、人還握著方向（不拿走控制，不像 GSD／BMAD 整包代操）。進行中票仍 dual-read 舊七檔。

<p align="center">
  <a href="https://rick546986.github.io/dev-flow/guides/guide-dev-flow.html#flow">
    <img src="https://rick546986.github.io/dev-flow/guides/fig-flow-full.svg" alt="五站流程圖：Intake→Decide→Spec→Build→Ship，只有 Ship 是預設人類停點">
  </a>
</p>
